...
TestObject saveButton = new TestObject().addProperty("xpath", ConditionType.CONTAINS, "//button[contains(@class, 'inline-flex') and normalize-space()='Save']")
WebUI.click(saveButton)
WebUI.executeJavaScript("window.scrollTo(0, document.body.scrollHeight);", null)

TestObject submitSpecimenButton = new TestObject().addProperty("xpath", ConditionType.CONTAINS, "//button[normalize-space()='Submit Spesimen']")
WebUI.click(submitSpecimenButton)
