...
Helper.selfSignMultiple()
WebUI.click(findTestObject('Object Repository/Page_Xignature App/div_Tanda Tangan2'))

WebUI.dragAndDropToObject(findTestObject('Page_Xignature App/div_Tanda Tangan'), findTestObject('Page_Xignature App/div_Tanda TanganUser Testing (You)'))
...
WebUI.verifyElementPresent(findTestObject("Object Repository/Page_Xignature App/a_Tampilkan Daftar Dokumen"), 5)
